...
class myResnet(nn.Module):
    def __init__(self, in_channels=3, num_out=10):
        ...
        self.stem_conv = nn.Conv2d(in_channels=in_channels, out_channels=32, kernel_size=3, padding=1)
        ...
        self.residual1 = residual_block(32)

        self.conv1 = nn.Sequential(nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, padding=1),
                                   nn.MaxPool2d(kernel_size=2, stride=2),
                                   nn.BatchNorm2d(64),
                                   nn.ReLU())
        ...
        self.fc1 = nn.Sequential(nn.Linear(8192, 512),
                                 nn.ReLU())
